...
<div class="splash">	
		    <legend>	
			    <div style="color:#fff; margin-bottom: 10px">
	            	...
	            	<div class="alert alert-success" style="text-transform: none"><img src="images/check_mark.png" /> An email has been sent to your inbox. 
	            		Please follow the instructions to recover your password.</div>
        </legend>
